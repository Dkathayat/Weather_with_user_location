package com.kathayat.testWeather.core.utils.datamapper
...
import com.kathayat.testWeather.core.data.source.local.entity.*
...
import com.kathayat.testWeather.core.data.source.local.entity.forecast.MainWeatherEntity
import com.example.devdigitalassignment.core.data.source.local.entity.WeatherItemEntity
import com.kathayat.testWeather.core.data.source.local.entity.currentforecast.CurrentWeatherEntity
import com.kathayat.testWeather.core.data.source.local.entity.currentforecast.CurrentWeatherSysEntity
...
import com.kathayat.testWeather.core.domain.model.currentforecast.CurrentWeatherSys
import com.kathayat.testWeather.core.domain.model.forecast.*
...
object MapperEntityToDomain {
    ...
    fun mapUserList(data: ForecastEntity?):UserWeatherTable {

            return UserWeatherTable(
                id = data?.cnt,
                city = data?.city?.name.toString(),
                temp = data?.list?.get(0)?.main?.temp.toString()
            )
